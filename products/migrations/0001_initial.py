    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('computers', 'computers'), ('phones', 'phones'), ('games', 'games'), ('books', 'books'), ('clothes', 'clothes')], max_length=100)),
                ('ratings', models.DecimalField(decimal_places=1, default=0, max_digits=1)),
